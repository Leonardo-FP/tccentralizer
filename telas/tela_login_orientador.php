...
<head>
    ...
    <title>Autenticação orientador</title>
        ...
        <div class="grid">
            <form action="../php/teste_login.php" method="POST" class="form login">
                ...
                <div class="form__field">
                    <label for="nomeOrientador"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Nome do orientador</span></label>
                    <input id="nomeOrientador" type="text" name="nomeOrientador" class="form__input" placeholder="Nome do orientador" required="">
                </div>
                ...
                <div class="form__field">
                    <input type="submit" name="submitOrientador" value="Entrar">
                </div>
