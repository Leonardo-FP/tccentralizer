...
<body>
    ...
    <div  class="align">
        <div class="grid">
            <form action="../php/dados_grupo.php" method="POST" class="form login">
        ...
        <br>
                ...
                <div class="form__field">
                    <label for="emailGrupo"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">E-mail</span></label>
                    <input id="emailGrupo" type="email" name="emailGrupo" class="form__input" placeholder="E-mail" required="">
                </div>

                <div class="form__field">
                    <label for="dataCadastroGrupo"><svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#user"></use></svg><span class="hidden">Data de Cadastro</span></label>
                    <input readonly id="dataCadastroGrupo" type="date" name="dataCadastroGrupo" class="form__input" placeholder="Data de Cadastro" value=<?php echo date('Y-m-d H:i:s'); ?>>
                </div>
            ...
            <p class="text--center">Já Possui cadastro? <a href="tela_login_grupo.php">Realize o Login</a> <svg class="icon"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="assets/images/icons.svg#arrow-right"></use></svg></p>
        </div>
    </div>
